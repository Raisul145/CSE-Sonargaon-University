...
void r()
{
    ...
    cout<<" Press 4 for Display Blue Flag "<<endl<<endl;
    cout<<" Press 5 for Display Cricket Field "<<endl<<endl;
    cout<<" Press 6 for Display German Flag "<<endl<<endl;
    cout<<" Press 7 for Display Bangladesh Flag "<<endl<<endl;
...
void d()
{
    ...
    // Set fill pattern to solid fill
    setfillstyle(SOLID_FILL, BLUE); // You can choose any color from predefined color list or use RGB value
    // Fill rectangle
